...
public class Check {
	 ...
	 * 
	 * @param phone
	 * @return 숫자 길이에 따라 hypen("-") 삽입 후 String 타입으로 반환<br>
	 ...
	 * @return 아이디@도메인주소 형식인 경우 true<br>
	 *         그 외 경우 false<br>
	 */
...
//		String pattern = "^[0-9a-zA-Z]([-_.]?[0-9a-zA-Z])*@[0-9a-zA-Z]([-_.]?[0-9a-zA-Z])*.[a-zA-Z]{2,3}$";
	 ...
	 * 
	 * @param phone String 타입의 전화번호
	 * @return 전화번호 형식 및 길이가 조건 충족 시 true<br>
	 *         그 외 false<br>
	 *         <br>
	 *         ex)<br>
	 *         02 123 4567 -> true<br>
	 ...
	 * @param date String 타입의 날짜("yyyy-MM-dd")
	 * @param time String 타입의 시간("HH:mm")
	 * @return 현재 시점으로부터 1시간 이후의 날짜와 시간인 경우 true<br>
	 ...
	 * @return 매개변수로 설정해준 숫자값 사이의 정수이며 그 값의 중복이 없는 경우 true<br>
	...
	public static boolean validateNumber_choiceMulti(String number, int firstNum, int lastNum) {
		...
		if (validateNumber(number)) {
			for (int i = 0; i < number.length(); i++) {
				if (!((firstNum + "").codePointAt(0) <= number.codePointAt(i)
						&& number.codePointAt(i) <= (lastNum + "").codePointAt(0))) {
					result = false;
				}
	 ...
	 * @param firstNum 제시된 선택 가능한 번호 중 첫번째 숫자
	 * @param lastNum  제시된 선택 가능한 번호 중 마지막 숫자
	 * @return 매개변수로 설정해 준 숫자값 사이의 하나의 정수인 경우 true<br>
	...
	public static boolean validateNumber_choiceOne(String number, int firstNum, int lastNum) {
		if (validateNumber(number)) {
			if (validateNumber(number)
					&& (firstNum <= Integer.parseInt(number) && Integer.parseInt(number) <= lastNum)) {
				return true;
			}
		}
		return false;
	 ...
	 * @return 한글만 작성 및 2자리~17자리 인 경우 true<br>
	 *         그 외(공백 포함) false<br>
	 */
	 ...
	 * @return 영문자와 숫자를 이용하여 4자리~20자리 인 경우 true<br>
	 *         그 외 false<br>
	 */
	 ...
	 * @return 한글 및 영문자, 숫자를 이용하여 2자리~10자리 인 경우 true<br>
	 *         그 외 false<br>
	 */
	 ...
	 * @return 영문자와 숫자를 이용하여 8자리~20자리 인 경우 true<br>
	 *         그 외 false<br>
	 */
	 ...
	 * @return 100자리 이내이며 첫 자리와 끝자리가 공백이 아닌 경우 true<br>
	 *         그 외 경우 false<br>
	 */
	 ...
	 * @return 30자리 이내이며 첫 자리와 끝자리가 공백이 아닌 경우 true<br>
	 *         그 외 경우 false<br>
	 */
